...
type
  ...
  public
    ...
    constructor Create(const HostToPing:String; Timeout:integer;PacketSize:Integer); overload;
  end;
...
constructor TThreadedPing.Create(const HostToPing:String; Timeout:integer;PacketSize:Integer);
begin
  inherited Create(False);
  Create(HostToPing);
  fTimeout:= Timeout;
